...
const tools = [
  ...
  { name: "wave", description: "This is a CHAT tool. You are sending a message to the Wave OS AI Assistant — another AI that lives inside Wave OS. You are NOT creating anything yourself. When the user types @wave, call this tool immediately with their message verbatim. Do not search for other tools, do not plan, do not interpret — just forward the message to Wave OS and return the response. Example: user says @wave create a note titled X — you call this tool with message=\"create a note titled X\" and Wave OS handles the rest.", inputSchema: { type: "object", properties: { message: { type: "string", description: "The user message verbatim — everything after @wave. Do not modify it." } }, required: ["message"], additionalProperties: false } },
